...
//
  ...
  private static final long[][] LATENCY_2019 = {
    ...
    private static final long[][] LATENCY_2019_PARTITIONED = {
      {32, 124, 184, 198, 151, 189},
      {124, 11, 227, 237, 252, 294},
      {184, 227, 88, 325, 301, 322},
      {198, 237, 325, 85, 58, 198},
  ...
  */
  private static double partition_degree = 0.001;
  private static final long[][] DOWNLOAD_BANDWIDTH_2019 = {
  ...
  private static final long[][] DOWNLOAD_BANDWIDTH_2019_PARTITIONED = {
      {52000000, (long)(40000000 * 1), (long)(18000000 * 1), (long)(22800000 * 1), (long)(22800000 * partition_degree), (long)(29900000 * 1)},
      {(long)(40000000 * 1), 40000000, 18000000, 22800000, 22800000, 29900000},
      {(long)(18000000 * 1), 18000000, 18000000, 18000000, 18000000, 18000000},
      {(long)(22800000 * 1), 22800000, 18000000, 22800000, 22800000, 22800000},
      {(long)(22800000 * partition_degree), 22800000, 18000000, 22800000, 22800000, 22800000},
      {(long)(29900000 * 1), 29900000, 18000000, 22800000, 22800000, 29900000}
  };

  /* Solar Superstorm
  private static final long[][] DOWNLOAD_BANDWIDTH_2019_PARTITIONED = {
      {52000000, 0, 18000000, 2280000, 0, 29900000},
      {0, 40000000, 18000000, 22800000, 22800000, 29900000},
      {18000000, 18000000, 18000000, 18000000, 18000000, 18000000},
      {2280000, 22800000, 18000000, 0, 22800000, 22800000},
      {0, 22800000, 18000000, 0, 22800000, 22800000},
      {29900000, 29900000, 18000000, 22800000, 22800000, 29900000}
  };
  */ 
  ...
  private static final long[][] UPLOAD_BANDWIDTH_2019_PARTITIONED = {
      {19200000, (long)(20700000 * 1), (long)(5800000 * 1), (long)(15700000 * 1), (long)(10200000 * partition_degree), (long)(11300000 * 1)},
      {(long)(20700000 * 1), 20700000, 5800000, 15700000, 10200000, 11300000},
      {(long)(5800000 * 1), 5800000, 5800000, 5800000, 5800000, 5800000},
      {(long)(15700000 * 1), 15700000, 5800000, 15700000, 10200000, 11300000},
      {(long)(10200000 * partition_degree), 10200000, 5800000, 10200000, 10200000, 10200000},
      {(long)(11300000 * 1), 11300000, 5800000, 11300000, 10200000, 11300000}
  };

  /* Solar Superstorm
  private static final long[][] UPLOAD_BANDWIDTH_2019_PARTITIONED = {
      {19200000, 0, 5800000, 1570000, 0, 11300000},
      {0, 20700000, 5800000, 15700000, 10200000, 11300000},
      {5800000, 5800000, 5800000, 5800000, 5800000, 5800000},
      {1570000, 15700000, 5800000, 15700000, 0, 11300000},
      {0, 10200000, 5800000, 10200000, 0, 10200000},
      {11300000, 11300000, 5800000, 11300000, 10200000, 11300000}
  };
  */
